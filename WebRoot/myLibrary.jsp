...
<body>
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li><a href="http://localhost:8080/MyLibrary/Library.jsp" target= "_blank">图书目库</a></li>
	...
	<div class="container">
		<div id="mylib_content">
			...
			<h3>规则名称 借期 预约 适用馆藏地</h3>
			<p>
				借期： 60天 &nbsp; 预约： 允许&nbsp;  续借： 允许.<br>
				文科阅览区,理科阅览区,外文阅览区,港台中文图书阅览区,港台西文图书阅览区.
			</p>
